...
linux: DEFINES += __linux__ GP_USE_GLEW
...
macx: ICON = gameplay-editor.icns
macx
{
    res.files = res
...
win32: DEFINES += WIN32 _WINDOWS _UNICODE UNICODE GP_USE_GLEW
...
win32: RC_FILE = gameplay-editor.rc
